...
public abstract class NetLayer {
     ...
     * @return 包装成的字符串。
     */
    public abstract String convert(NetField arg) throws Exception;
     ...
     */
    public abstract NetField parse(String str) throws ParseException;
     ...
     * @return
     */
    public abstract boolean validate(String headerStr);
}
